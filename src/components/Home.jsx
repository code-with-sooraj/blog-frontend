  ...
  return (
    <div className='flex flex-col w-full items-center justify-center py-3 gap-2'>
        <div className="container w-5/6 flex flex-col gap-4">
            {/* 🔽 Marquee Description */}
            <marquee className="text-md text-blue-700 dark:text-red-600 font-medium mb-2" behavior="scroll" direction="left">
        ...
        <div className="container w-5/6 flex flex-col gap-4">
            <div className="w-full flex justify-between mb-4">
                <h2 className='font-medium text-2xl'>Latest Blogs
                </h2>
                <Link to="/blog" className="text-sm px-3 py-1 bg-gray-100 dark:bg-gray-700 hover:font-semibold text-gray-900 dark:text-white rounded-md transition">Explore Blogs</Link>
            </div>
